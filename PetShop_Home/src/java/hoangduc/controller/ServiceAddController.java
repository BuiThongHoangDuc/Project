...
public class ServiceAddController extends HttpServlet {
    ...
    private static final String INVALID = "/admin/serviceaddform.jsp";
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ServiceDTO dto = new ServiceDTO(name, image, type, price, false);
            ...
            {
                url = INVALID;
                request.setAttribute("INVALID", "Service Is Already Inside");
            }
        }
        finally
        {
