...
public class ServiceSearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ServiceDTO> result = dao.findByLikeName(search);
            request.setAttribute("LISTSERVICE", result);
        ...
        {
            request.getRequestDispatcher("/admin/servicetable.jsp").forward(request, response);
        }
    }
