<%-- 
    ...
    Created on : Jul 5, 2019, 2:08:06 PM
    Author     : ADMIN
--%>
                    ...
                    <div class="card-body card-block">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><textarea type="text" id="text-input" name="detail"  class="form-control" required></textarea></div>
                            </div>

                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">Quantity</label></div>
                                <div class="col-12 col-md-9"><input type="number" id="text-input" name="quantity"  class="form-control" min="1" max="999" required></div>
                            </div>
                        ...
                        <div class="card-footer">
                            ...
                            <button type="submit" name="action" value="Add Product" class="btn btn-primary btn-sm">
